...
path = "./SETS/MI-LSD/MI-LSD_sO2_melanin_skin_"
...
np.save("./MI-LSD_sO2_skin_TRAIN_array_label_sO2.npy", label_rCu[:i])
np.save("./MI-LSD_sO2_skin_TRAIN_array_vol_id.npy", vol_id[:i])
np.save("./MI-LSD_sO2_skin_TRAIN_array_spectra.npy", spectra[:,:,:i])
