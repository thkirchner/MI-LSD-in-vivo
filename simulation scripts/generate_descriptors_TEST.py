...
np.save("./MI-LSD_sO2_skin_TEST_array_label_sO2.npy", label_rCu[:i])
np.save("./MI-LSD_sO2_skin_TEST_array_vol_id.npy", vol_id[:i])
np.save("./MI-LSD_sO2_skin_TEST_array_spectra.npy", spectra[:,:,:i])
